...
Ingresa Señal de control, S[34:53]

Sale Señal de habilitación de carga (1 bit)
"""

def logica_ramificacion(senal_control, registro_F): # Sólo las señales S[33:52]
    ...
    bsr = senal_control[17]             # S[51]
    rts = senal_control[18]

    habilitacion_carga = int(ramificacion_1 or ramificacion_2 or bsr or rts)
