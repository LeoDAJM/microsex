...
"NOP": [[0x00], 1],
#"VBC": [[0x20], 1], "VBD": [[0x30], 1],
#"VAC": [[0x90], 1], "VAD": [[0xA0], 1],
"CLC": [[0x20], 1], "CLV": [[0x30], 1],
"SEC": [[0x90], 1], "SEV": [[0xA0], 1],

"IMP A": [[0x02], 1], "IMP B": [[0x12], 1], "IMP C": [[0x22], 1],
"EXP A": [[0x1F], 1],

#"BOR A": [[0x01], 1], "NEG A": [[0x03], 1], "CPL A": [[0x04], 1],
...
#"BOR B": [[0x11], 1], "NEG B": [[0x13], 1], "CPL B": [[0x14], 1],
...
"BOR C": [[0x21], 1], "NEG C": [[0x23], 1], "CPL C": [[0x24], 1],
...
#"LDA X,M": [[0xBF], 3], "GDA X,M": [[0xB0], 3],
#"LDA Y,M": [[0xFF], 3], "GDA Y,M": [[0xF0], 3],
#"LDA P,M": [[0xF3], 3], "GDA P,M": [[0xF4], 3],
...
#"LDA A,IX": [[0x80, 0x01], 3], "GDA A,IX": [[0x80, 0x02], 3],
...
#"LDA B,IX": [[0x80, 0x11], 3], "GDA B,IX": [[0x80, 0x12], 3],
...
#"LDA C,IX": [[0x80, 0x21], 3], "GDA C,IX": [[0x80, 0x22], 3],
...
#"BOR IX": [[0x80, 0x41], 3], "NEG IX": [[0x80, 0x43], 3], "CPL IX": [[0x80, 0x44], 3],
...
#"LDA A,IY": [[0x80, 0x81], 3], "GDA A,IY": [[0x80, 0x82], 3],
...
#"LDA B,IY": [[0x80, 0x91], 3], "GDA B,IY": [[0x80, 0x92], 3],
...
#"LDA C,IY": [[0x80, 0xA1], 3], "GDA C,IY": [[0x80, 0xA2], 3],
...
#"BOR IY": [[0x80, 0xC1], 3], "NEG IY": [[0x80, 0xC3], 3], "CPL IY": [[0x80, 0xC4], 3],
...
#'CPL' : [['acumuladores', 'indexado', 'directo']],
...
#'GDA' : [['acumuladores', 'punteros', 'ppila'],['indexado', 'directo']],
